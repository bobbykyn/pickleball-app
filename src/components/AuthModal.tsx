        ...
        if (data.user) {
          const { error: profileError } = await supabase
            ...
            .insert({
              ...
              google_avatar_url: data.user.user_metadata?.avatar_url || null
            })
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg p-6 w-full max-w-md mx-4">
        ...
        <h2 className="text-xl font-bold text-gray-900">
          ...
          <button onClick={onClose} className="font-bold text-gray-900 hover:text-gray-700">
            <X className="w-5 h-5" />
          </button>
        </div>
...
<button
  ...
  disabled={loading}
  className="w-full bg-white border border-gray-300 text-gray-700 p-3 rounded-lg font-medium hover:bg-gray-50 disabled:opacity-50 transition-colors flex items-center justify-center space-x-2"
>
